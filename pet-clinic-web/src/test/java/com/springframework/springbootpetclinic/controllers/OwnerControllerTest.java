...
class OwnerControllerTest {
    ...
    void displayOwner() throws Exception {
        when(ownerService.findById(anyLong())).thenReturn(Owner.ownerBuilder().id(1L).firstName("testName").build());
    ...
    void processCreationForm() throws Exception {
        when(ownerService.save(ArgumentMatchers.any())).thenReturn(Owner.ownerBuilder().id(1L).build());
    ...
    void processFindFormReturnMany() throws Exception {
        when(ownerService.findAllByLastNameLike(anyString()))
                .thenReturn(
                        Arrays.asList(
                                Owner.ownerBuilder().id(1l).build(),
